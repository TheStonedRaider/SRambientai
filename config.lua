...
Config.MaxPerPlayer = 35 --------- How many cars are spawned per player, 
...
Config.DisToHalf = 150   ---- Distance 

Config.minSpawndis = 80   ----- Minimum spawning distance from player

Config.MaxSpawndis = 190   ----- Maximum spawning distance from player 

Config.minSpawndis2 = 80 ----- Minimum spawning distance from  other players (best kept the same as Config.minSpawndis
...
Config.PoshCityMulti = 0.9   ---- Rockford hills  

Config.PaletoMulti = 0.9    ---- Paleto bay  

Config.SandyMulti = 0.9   ---- Sandy Shores  

Config.IndustrialMulti = 0.9   ---- All Industrial/work areas

Config.ElseAreaMulti = 0.9    ---- Eveywhere else 
